export const items = [
  ...
  },
  {
    ...
    name: 'Город',
    answers: ['Санкт-Петербург', 'Москва', 'Новосибирск', 'Нижний Новгород', 'Ростов-на-Дону'],
    type: 'select',
  },
  {
    id: 3,
    title: 'Какое образование уже есть?',
    answers: ['9 классов', '11 классов', 'Училище', 'Колледж/техникум', '11 классов', 'Неоконченное высшее'],
    type: 'radio',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    name: 'Специальность',
    answers: ['Любая', 'Экономика', 'Философия', 'Социология', 'Юриспруденция', 'Менеджмент'],
    type: 'select',
  },
  {
    id: 8,
